...
<div class="container my-5">
  ...
  <p class="text-gray-600 mb-8">Examples of redirect, flash messages, and browser events triggered from controller
    actions</p>
    ...
    <section class="card p-6 shadow-sm">
      ...
      <div class="flex gap-2">
        <button fw:click="openModal" fw:param-modalId="confirmDelete" fw:param-title="Confirm Delete"
          fw:param-message="Are you sure you want to delete this item?" class="btn btn-primary">
          Open Delete Modal
        </button>
        <button fw:click="openModal" fw:param-modalId="infoModal" fw:param-title="Information"
          fw:param-message="This is an informational modal" class="btn btn-secondary">
          Open Info Modal
        </button>
      </div>
    </section>
