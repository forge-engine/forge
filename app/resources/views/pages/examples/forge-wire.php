...
<div class="container my-5">
    ...
    <div <?= fw_id('keydown-demo') ?> class="card p-4 shadow-sm mb-4">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <input type="text" fw:keydown.escape="handleEscape" class="form-control"
  ...
  <section class="mb-8">
    ...
    <p class="mb-4 text-gray-600">These two islands share the same counter state using
      <code>#[State(shared: true)]</code>. Updating one updates both automatically.
    </p>
