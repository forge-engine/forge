...
{
    /** Columns are fixed for demo: todo / doing / done */
    #[State] public array $columns = [];
    #[State] public int $nextId = 1;

    // compose (add-card) UI
    #[State] public ?string $composeColumn = null;
    #[State] public string $newText = '';

    // edit UI
    #[State] public ?int $editingId = null;
    #[State] public string $editText = '';
    ...
    /** Locate card by id. Returns [colIdx, cardIdx] or [null, null] */
    ...
    #[Action] public function compose(string $colId): void
    {
        $this->composeColumn = $colId;
        $this->newText = '';
    }

    #[Action] public function cancelCompose(): void
    {
        $this->composeColumn = null;
        $this->newText = '';
    }

    #[Action] public function create(string $colId): void
    {
        ...
        // idempotency-ish: ignore if last inserted has same title & just happened
    ...
    #[Action] public function edit(int $id): void
    {
    ...
    #[Action] public function saveEdit(int $id): void
    {
        [$ci, $ti] = $this->locate($id);
        if ($ci === null) {
            return;
    ...
    #[Action] public function cancelEdit(): void
    {
        $this->editingId = null;
        $this->editText  = '';
    }
    ...
    #[Action] public function remove(int $id): void
    {
        [$ci, $ti] = $this->locate($id);
        if ($ci === null) {
            return;
    ...
    #[Action] public function moveLeft(int $id): void
    {
        [$ci, $ti] = $this->locate($id);
        if ($ci === null || $ci === 0) {
            return;
    ...
    #[Action] public function moveRight(int $id): void
    {
        [$ci, $ti] = $this->locate($id);
