...
{
    #[State] public bool $show = false;
    #[State] public int $userId;
    ...
    #[Action] public function open(): void
    {
        $this->show = true;
    }
    #[Action] public function close(): void
    {
        $this->show = false;
    }
    ...
    {
        return $this->view('ParentWithModal/View', [
            'show' => $this->show,
            'userId' => $this->userId,
        ]);
    }
