...
#[Module(name: 'ForgeDatabaseSQL', version: '0.1.0', description: 'SQL database support (SQLite, MySQL, PostgreSQL)',
    order: 0, type: 'core')]
#[Service]
#[Compatibility(framework: '>=0.1.0', php: '>=8.3')]
#[Requires(interface: DatabaseConnectionInterface::class, version: '>=0.1.0')]
#[Repository(type: 'git', url: 'https://github.com/forge-engine/modules')]
#[Provides(interface: 'forge-database-sql', version: '0.1.0')]
