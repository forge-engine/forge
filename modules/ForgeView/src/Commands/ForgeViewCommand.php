...
namespace App\Modules\ForgeView\Commands;
...
#[Cli(
    command: 'forge-view:greet',
    description: 'Example command for ForgeView Module',
    usage: 'forge-view:greet [--type=app|module] [--module=ModuleName] [--name=Example]',
    examples: [
        'forge-view:event --type=app --name=Example',
        'forge-view:event --type=app --name=Example --path=Test',
        'forge-view:event --type=module --module=Blog --name=Example',
        'forge-view:event   (starts wizard)',
    ]
)]
final class ForgeViewCommand extends Command
{
    use StringHelper;
    use CliGenerator;
