...
<div class="forge-debugbar" style="display: none;">
    ...
    <div class="forge-debugbar-metrics">
        ...
        <div class="forge-debugbar-tab " data-tab="messages">Messages <span class="forge-debugbar-tab-count">(<?= count($data['messages'] ?? []) ?>)</span></div>
        <div class="forge-debugbar-tab" data-tab="timeline">Timeline <span class="forge-debugbar-tab-count">(<?= count($data['timeline'] ?? []) ?>)</span></div>
    ...
    <div class="forge-debugbar-item">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="forge-debugbar-icon size-6">
...
<div class="forge-debugbar-panel" id="debugbar-panel-memory">
    ...
    <ul class="forge-debugbar-memory-list">
        ...
        <li class="forge-debugbar-memory-item">
            ...
            <div class="forge-debugbar-memory-value forge-debugbar-memory-peak"><?= htmlspecialchars($data['memory']['peak'] ?? 'N/A') ?></div>
        </li>
        ...
        <li class="forge-debugbar-memory-item usage-bar-item">
            ...
            <div class="forge-debugbar-memory-value">
                <div class="forge-debugbar-memory-bar">
                    <div class="forge-debugbar-memory-bar-fill <?= $bar_class ?>" style="width: <?= htmlspecialchars($percentage) ?>"></div>
                </div>
    ...
    <div class="forge-debugbar-panel" id="debugbar-panel-timeline">
        ...
        <ol class="debugbar-timeline-list">
            ...
            <li class="debugbar-timeline-item">
                ...
                <strong class="debugbar-timeline-name"><?= htmlspecialchars($event['name'] ?? '') ?> <?= htmlspecialchars($event['origin'] ?? '') ?></strong>
    ...
    <div class="forge-debugbar-panel" id="debugbar-panel-route">
        ...
        <div class="forge-debugbar-current-route-table">
            ...
            <div class="forge-debugbar-route-row">
                ...
                <div class="forge-debugbar-route-value">
                    <span class="forge-debugbar-route-handler-value"><?= htmlspecialchars($data['route']['handler'] ?? '') ?></span>
                </div>
            </div>
            ...
            <div class="forge-debugbar-route-row">
                ...
                <div class="forge-debugbar-route-value">
                    <span class="forge-debugbar-route-namespace-value"><?= htmlspecialchars($data['route']['namespace'] ?? '') ?></span>
                </div>
            </div>
            <?php endif; ?>
        ...
        <div class="forge-debugbar-query-entry <?= $performanceClass; ?>">
            ...
            <div class="forge-debugbar-query-secondary-info">
                ...
                <div class="forge-debugbar-info-item">
                    ...
                    <span class="forge-debugbar-query-database"><?= htmlspecialchars($queryData['connection_name'] ?? '') ?></span>
                </div>
            </div>
