...
final class HubItemRegistry
{
  ...
  public function refresh(): void
  {
    ...
    if ($hasChanges || !file_exists(self::CLASS_MAP_FILE)) {
  ...
  {
    $currentMtime = file_exists(self::CLASS_MAP_FILE) ? filemtime(self::CLASS_MAP_FILE) : 0;
  ...
  {
    if (!file_exists(self::CLASS_MAP_FILE)) {
      return [];
    }
