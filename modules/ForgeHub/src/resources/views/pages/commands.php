    ...
    <div class="card mb-sm">
        <div class="card--body">
            <div class="terminal">
                ...
                <div class="terminal__output" id="cliOutput">
                    ...
                    <form method="post" action="/hub/commands/send-input" class="form flex flex--gap-sm mt-sm">
                        <div class="form--group flex-grow">
                            ...
                            <input type="text" name="input" id="input" class="form--input" placeholder="Enter your response" autocomplete="off">
                        </div>
                ...
                <form method="post" action="/hub/commands/execute" class="form flex flex--gap-sm terminal__input" id="commandForm">
                    <label for="command" class="form--label sr-only">$</label>
                    <input type="text" name="command" id="command" class="form--input" placeholder="Enter Forge command" autocomplete="off">
