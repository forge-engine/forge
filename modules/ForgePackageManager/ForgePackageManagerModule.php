...
use Forge\Modules\ForgePackageManager\Src\Commands\ModuleListCommand;
...
class ForgePackageManagerModule extends ModulesInterface
{
    public function register(Container $container): void
    {
        if (PHP_SAPI === 'cli') {
            ...
            $container->bind(CommandInterface::class, ModuleListCommand::class);
            ...
            $container->tag(ModuleListCommand::class, ["module.command"]);
        }
    }
}